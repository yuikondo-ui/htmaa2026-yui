...
status: WIP
hero: img/week01/skirt_render.jpg
...
![Inspiration board: Refashion, Anrealage, Textile Studies, upcycled denim, modular pixel garments](img/week01/ref_board.jpg)
...
:::cols
![Issey Miyake, triangulated white garment on the runway](img/week01/ref_issey_miyake.jpg)
...
![Ilaria Lepore, Hiroi Trousers](img/week01/ref_hiroi_trousers.jpg)
...
![Kuon vintage boro patchwork pullover](img/week01/ref_kuon.jpg)
...
:::embed files/week01/week02_preview_en.html | Interactive prototype: mannequin and skirt (Three.js)

## The triangle kit

I started with panels made from triangles, written in Python with Claude as `modkit.py`.

![Kit parts: tri, tile, half, dart, connectors](img/week01/kit_parts.jpg)
...
:::cols natural
![Sketch: triangle with one fully dimensioned slot](img/week01/fusion_01_slot_dimensions.jpg)
*The triangle with one fully constrained slot. Every dimension is a parameter or an expression.*
![Rectangular Pattern dialog](img/week01/fusion_02_rect_pattern.jpg)
...
:::cols natural
![Wrong profile selection](img/week01/fusion_03_extrude_wrong.jpg)
*Wrong: the six slot profiles are selected in blue. The right pick is the one large face.*
![Finished panel body](img/week01/fusion_04_panel.jpg)
*The finished panel body after the fillet.*
![Connector inserted in a panel slot](img/week01/fusion_05_connector_inserted.jpg)
...
:::cols
![Cut test grid, xTool F1 Ultra, cardboard](img/week01/group_cut_test_f1ultra.jpg)
...
![Name tags](img/week01/group_name_tags.jpg)
*Name tags.*
...
:::cols tall
![Fit test strip](img/week01/fit_test_1.jpg)
*Fit test 1. All eight slots, down to −0.4 mm, were loose.*
![Fit test 3: labelled triangles and connectors](img/week01/fit_test_3.jpg)
...
![Parts from the cut that caught fire](img/week01/fire_parts.jpg)
...
:::cols tall
![Plywood parts cut at 90 % / 30 mm/s](img/week01/broken_wood.jpg)
*90 % power, 30 mm/s: not through. Pressing the parts out broke the narrow sections.*
![Plywood fit test strips](img/week01/fit_test.jpg)
...
:::cols tall
![Three panels joined](img/week01/assembly_1.jpg)
*Three panels, d–u–d, joined with the angled connectors. The surface curves.*
![The first ring assembled](img/week01/assembly_2.jpg)
...
:::cols tall
![Connectors with a 10 mm neck](img/week01/neck_10mm.jpg)
*The recut connectors with a 10 mm neck.*
![Two rings assembled](img/week01/assembly_3.jpg)
*Two rings assembled with the 10 mm connectors. The panels seat, but the vertical edges drift.*
![The kit sprayed purple and gold](img/week01/colored.jpg)
...
A side project, inspired by patterned nori with the asanoha (麻の葉) motif. I made the pattern file with Claude ([asanoha_nori.svg](img/week01/asanoha_nori.svg)), engraved asanoha and cut sakura into sheets of nori on the laser, and made onigiri with it.

:::cols
![Reference: asanoha patterned nori](img/week01/ref_nori_asanoha.jpg)
...
![Engraved asanoha nori](img/week01/nori_asanoha_engraved.jpg)
*Asanoha engraved into a sheet of nori.*
![Sakura cut-outs in nori](img/week01/nori_sakura_cut.jpg)
*Sakura cut out of nori.*
![Onigiri wrapped in sakura nori](img/week01/nori_onigiri.jpg)
...
Everything is under `files/week01/` in the [repo](https://github.com/yuikondo-ui/htmaa2026-yui/tree/main/files/week01). `modkit.py` is the panel and connector generator with the fit test; `skirt.py` the flared skirt with per-ring panels and connectors at the needed angles; `mannequin.py` the waffle mannequin. The cut files are zipped: [out_skirt.zip](files/week01/out_skirt.zip) (panels, connectors and the 600 × 400 sheet), [out_mannequin.zip](files/week01/out_mannequin.zip) (two sheets) and [fit_tests.zip](files/week01/fit_tests.zip). `week02_preview_en.html` is the interactive preview, a single file with no build step. `triangle.f3d` is the Fusion version of panel and connector, parametric. `asanoha_nori.svg` is the nori pattern.
